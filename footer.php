         ...
         ?>
                <ul class="list-none mt-4">
                    <li class="flex items-center p-2">
                        <img src=" <?php echo get_template_directory_uri() ?>./images/message.png" alt="mail-Icon"
                            class="mr-2">
                        <span class="paragraph">hello@skillbridge.com</span>
                    </li>
                    <li class="flex items-center p-2">
                        <img src=" <?php echo get_template_directory_uri() ?>./images/call.png" alt="phone-Icon"
                            class="mr-2">
                        <span class="paragraph">+91 91813 23 2409</span>
                    </li>
                    <li class="flex items-center p-2">
                        <img src=" <?php echo get_template_directory_uri() ?>./images/mark.png" alt="location-Icon"
                            class="mr-2">
            ...
            <div class="col-span-1">
                ...
                <ul class="list-none">
                    <li class="benefits-text mb-2 text-[#59595A] font-be-vietnam-pro text-base font-normal leading-6">
                        Benefits</li>
                    <li class="benefits-text mb-2 text-[#59595A] font-be-vietnam-pro text-base font-normal leading-6">
                        Our Courses</li>
                    <li class="benefits-text mb-2 text-[#59595A] font-be-vietnam-pro text-base font-normal leading-6">

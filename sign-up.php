            ...
            <div class="col ">
                ...
                <div class="flex justify-between items-center p-3 bg-white-95 rounded-b-lg">
                    <div class="flex items-center">
                        <img src="<?php echo get_template_directory_uri() ?> ./images/mens.png" alt="sarah"
            ...
            <form action="#" autocomplete="off">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email"
                        class="w-full bg-white-97 focus:outline-none border-white-95 mt-2 px-3 py-2 border border-gray-300 rounded-md focus:ring-orange-500 focus:border-orange-500"
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="password" id="password" autocomplete="new-password" name="password"
                            class="w-full  border-white-95 mt-2 focus:outline-none border-none bg-white-97 px-3 py-2 border border-gray-300 rounded-md focus:ring-orange-500 focus:border-orange-500"
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="remember" class="ml-2 text-sm text-gray-900">I agree with <span class="underline">Terms
                            of Use</span> and <span class="underline"> Privacy Policy</span></label>
                </div>

                <div>
                    <button type="submit"
                        class="w-full bg-orange-50 text-white-99 py-2 px-4 rounded-md hover:bg-orange-600 transition">Login</button>
                </div>
                ...
                <div>
                    <button type="button"
                        class="w-full gap-2 flex items-center justify-center bg-white-97 border-white-95 mt-4 text-gray-700 py-2 px-4  border-gray-300 rounded-md shadow-sm hover:bg-gray-50 transition">

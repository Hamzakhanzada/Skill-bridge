        ...
        <div class="mb-10 lg:mb-0 ">
            ...
            <div class="flex justify-between items-center p-3 bg-white-95 rounded-b-lg">
                <div class="flex items-center">
                    <img src="<?php echo get_template_directory_uri() ?> ./images/mens.png" alt="sarah" class="w-10 h-10 rounded-full">
        ...
        <div class="w-full mx-auto lg:mx-0 bg-white-99  p-8 rounded-lg">
            ...
            <form action="#" autocomplete="off" >
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="remember" class="ml-2 text-sm text-gray-900">I agree with  <span class="underline">Terms of Use</span> and <span class="underline">  Privacy Policy</span></label>
                </div>
